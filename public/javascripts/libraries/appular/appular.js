  ...
  Appular.initialize = {
    ...
    components: function() {
      _.each($components, function(element) {
        var $element = $(element);
        var name = $element.data('appularComponent');
        var options = {
          el: $element
        };
    ...
    return View.extend({
      ...
      constructor: function(options) {
        ...
        _.each(this.listeners, function(value, key) {
          ...
          var callback = _.isFunction(value) ? value : this[value];
    ...
    return Router.extend({
      ...
      renderAll: function() {
        _.each(this.components, function(component, name) {
          component.render();
          Appular.log('Component', name, 'Render');
        });
      },
      setup: function() {
        this.start();
      ...
      generateHash: function() {
        ...
        var hash = '';
        var value;
        var currentParams = this.getParams() ? this.getParams().split(this.separators.param) : [];
